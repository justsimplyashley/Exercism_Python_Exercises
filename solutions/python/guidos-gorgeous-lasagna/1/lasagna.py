...
def preparation_time_in_minutes(number_of_layers):
    """ Calculate the preparation time in minutes.
        ...
        This function takes one parameter integer representing the number of lasagna layers multiplies it by the preparation time 2 minutes given by the global variable.
    """
